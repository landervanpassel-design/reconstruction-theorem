...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.21017251.svg)](https://doi.org/10.5281/zenodo.21017251)
...
**Archive:** [https://doi.org/10.5281/zenodo.21017251](https://doi.org/10.5281/zenodo.21017251)
...
A typeset **PDF** is the recommended primary artifact for the archive. To produce one from the
...
The numerical claims of **§14.2 (Experiment E — the three-face risk-layer duality)** are
reproduced **verbatim, with no free parameters and no post-hoc fitting**, by a single
self-contained script. It requires only Node.js (no dependencies):
...
- **Output:** model constants, then the three faces of the risk layer — Pillar-II schedule
  ...
  large-deviation price — cross-checked against the exact inverse-Gaussian first-passage law.
...
This work is archived on Zenodo at **[doi.org/10.5281/zenodo.21017251](https://doi.org/10.5281/zenodo.21017251)**.
Please cite the record (see `CITATION.cff`); a representative BibTeX entry is:
...
@misc{vanpassel2026reconstruction,
  ...
  doi          = {10.5281/zenodo.21017251},
  url          = {https://doi.org/10.5281/zenodo.21017251},
